            ...
            if ($type == 'general') {
                ...
                $options = [
                    ...
                    'proxycheck_apikey'     => [
                        ...
                        'description' => '🔑 Get your free API key at <a href="https://proxycheck.io/" target="_blank" style="color: #3b82f6;">proxycheck.io</a> • Free tier: 1,000 queries/day • Paid plans available for higher volume'
                    ],
                    'antiproxy1'            => [
                        'id'          => 'antiproxy1',
                        'title'       => 'Block Message',
